  ...
  if (!isset($display)) {
    $conditionalCheck = new ConditionalTagCheck(
      ...
      [
        'is_404',
        'is_front_page',
	      ['is_page_template', 'template-squeeze.php'],
        ['is_page_template', 'template-forms.php'],
        ['is_page_template', 'template-course.php'],
        ['is_page_template', 'template-welcome.php'],
        ['is_page_template', 'template-sales.php']
      ]
    );
